...
public class Multithreading extends Thread{
    ...
    public static void runningAnimation(){
        ...
        tanim=new Timeline(new KeyFrame(Duration.millis(250), actionEvent -> {

            if(!OurHero.isHeromovingflag()){
                tanim.stop();
            }
           // System.out.println("Altering");
            Timeline temp0=new Timeline(new KeyFrame(Duration.millis(125),actionEventnull->
            {;}));
...
//            b4.setVisible(true);
            ...
            Timeline temp=new Timeline(new KeyFrame(Duration.millis(125),actionEventnull->
            {;}));
