...
//    }
    ...
    public void pauseMenu() {
        ...
        MainButton.setOnMousePressed(mouseEvent -> {
            ...
            try {
                ...
                rg.changeScene(2);//IMPLEMENTED USING FACADE Design Pattern
            } catch (IOException e) {
        ...
        saveButton.setOnAction(actionEvent -> {
            ...
            Text t=new Text("   Game Saved!");
            t.setFill(Color.BLACK);
            t.setY(350);
            t.setX(150);
            t.setTextAlignment(TextAlignment.CENTER);
            t.setFont(new Font(30));
            Button btn=createButton("Ok",238.0, 425.0, 32.0);
            btn.setStyle(
                    "-fx-background-color: #ff5275; " +  // Green background color
                            "-fx-text-fill: white; " +          // White text color
                            "-fx-font-size: 26px; " +           // Font size
            ...
            root.getChildren().addAll(r,t,btn);
            btn.setOnAction(actionEvent1 -> {
                root.getChildren().removeAll(r,t,btn);
            });
            //
        });
    ...
    public void updateCherryCount(){
        ...
        cherrycount = createText(": "+OurHero.getInstance().getCherrycount(), 60.0, 50.0, 30.0, new Glow(0));
